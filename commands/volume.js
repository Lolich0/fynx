...
module.exports.run = async (client, message, args) => {
  ...
  if (isNaN(args[0])) return message.channel.send({embed: {color: "RED", description: `<a:yanlis:734892943332212764>  | Ses seviyesini ayarlayabilmek için sadece bir doğal sayı giriniz.` }})
