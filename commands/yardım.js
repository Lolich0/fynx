...
module.exports.run = (client, message, args) => {
  ...
  let pages = [
              ...
              '<:site:735595781226102795>  | [Fynx Music İnternet Sayfası Yakında](https://google.com/)\n\n<:bot:734888733853089903>  | [Fynx Music`u Sunucunuza Ekleyin+](https://discordapp.com/oauth2/authorize?client_id=522870338867167254&scope=bot&permissions=8)\n\n<:discord:734888645722636441>  | [Fynx Music Destek Sunucusu](https://discord.gg/fynxcode)\n\n<:instagram:734889120848937011>  | [Harmony Yapımcı İnstagram Hesabı](https://instagram.com/m_arda_dusova)',
              ];
  let page = 1;
